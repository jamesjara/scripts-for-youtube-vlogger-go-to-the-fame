...
/*
 * @jamesjara
 * Use this for YouTube for Instant and Free Transcription
 * */
class YoutubeCaptions 
{
	...
	function proccessUrl($video_url)
		{
		if (isset($_GET['ct']))
			{
	...
	function proccessCaptionTrack($caption_track_url)
		{
...
$youtuber_captions = new YoutubeCaptions();
